          ...
          <table className="min-w-full border-[1px] border-gray-200 my-8 overflow-x-scroll">
            <tbody>
              <tr className="border-b border-[1px] border-gray-500 ">
                <td className="text-sm font-bold text-dark  bg-gray-100 px-2 py-3 whitespace-nowrap border-r border-gray-200 border-[1px] border-b-gray-200">
                  Shop Number
                </td>
                <td className="text-sm  font-regular px-2 py-3 whitespace-nowrap border border-gray-200 border-1">
